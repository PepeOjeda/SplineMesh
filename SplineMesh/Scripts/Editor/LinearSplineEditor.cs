...
namespace SplineMesh {
    ...
    public class LinearSplineEditor : Editor {
        ...
        private LinearSpline spline { get { return (LinearSpline)serializedObject.targetObject; } }
        ...
        void OnSceneGUI() {
            ...
            foreach (LinearCurve curve in spline.GetCurves()) {
                Handles.DrawAAPolyLine(spline.transform.TransformPoint(curve.n1.Position),
