...
namespace SplineMesh {
    ...
    public class BezierSplineEditor : Editor {
        ...
        private BezierSpline spline { get { return (BezierSpline)serializedObject.targetObject; } }
        ...
        public override void OnInspectorGUI() {
			...
			spline.StepsPerCurve = EditorGUILayout.IntSlider("Number of samples per curve", spline.StepsPerCurve, 1, 50);
        ...
        [MenuItem("GameObject/3D Object/Spline/Bezier Spline")]
